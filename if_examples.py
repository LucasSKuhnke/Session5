...
drinks = ["whiskey", "rum", "tequila", "gin", "sake", "wine", "beer", "vodka", "champagne", "cognac"]
mixers = ["fanta", "fanta lemon", "red bull", "tonic", "cola", "soda"]
...
try:
    ...
    print("I dont have time for your game! Get out!")
